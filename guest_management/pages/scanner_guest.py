    ...
    return rx.center(
        rx.vstack(
            ...
            rx.vstack(
                ...
                rx.text(
                    "Multi-Scanner Check-In Station",
                    color=LIGHT_GRAY,
                    size="2",
                    text_align="center",
                ),
                            ...
                            rx.vstack(
                                ...
                                rx.cond(
                                    ...
                                    rx.vstack(
                                        ...
                                        rx.text("Ready for QR codes from any connected scanner", color="gray", size="2"),
                                        spacing="1",
                                        align="center",
                                    ),
                                    rx.vstack(
                                        rx.text("SCANNERS STANDBY", size="4", weight="bold", color="gray"),
                                        rx.text("Click START to activate all connected scanners", color="gray", size="2"),
                                        spacing="1",
                                        align="center",
                                    ),
                                ),
                ...
                rx.cond(
                    ...
                    rx.button(
                        rx.hstack(
                            ...
                            rx.text("START SCANNERS", size="4", weight="bold"),
                            spacing="2",
                        ),
                ...
                rx.cond(
                    ...
                    rx.vstack(
                        rx.hstack(
                            ...
                            rx.text("All scanners active", size="2", color="green"),
                            spacing="2",
                        ),
                        rx.hstack(
                            rx.button(
