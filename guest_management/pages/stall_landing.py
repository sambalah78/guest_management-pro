                    ...
                    rx.cond(
                        ...
                        rx.vstack(
                            rx.vstack(
                                ...
                                rx.text("Enter your Guest ID and Voucher Access Code", color="white", text_align="center"),
                                spacing="3",
                                align="center",
                            ),
                            rx.divider(),
                            ...
                            rx.vstack(
                                rx.text("Voucher Access Code", color="gray", size="2", align_self="start"),
                                rx.input(
                                    placeholder="Enter your 16-character access code",
                                    value=VoucherState.voucher_access_code_input,
                                    on_change=VoucherState.set_voucher_access_code_input,
                                    type="password",
                                    width="100%",
                                    bg=BLACK,
                                    border_color=GOLD,
                            ...
                            rx.text("Your Guest ID and Voucher Access Code are provided in your invitation email", color="gray", size="1", text_align="center"),
                            spacing="4",
                            padding="2em",
                            width="100%",
                        ),
