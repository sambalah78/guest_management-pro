                        ...
                        lambda guest: rx.table.row(
                            ...
                            rx.table.cell(
                                rx.hstack(
                                    ...
                                    # This sends directly through EmailState's
                                    # durable email queue.  The button text is
                                    # based only on the real boolean `email_sent`.
                                    rx.button(
                                        rx.hstack(
                                            rx.icon(
                                                tag="mail",
                                        ...
                                        on_click=lambda: EmailState.send_guest_email_for_guest(
                                            guest
                                        ),
                                        size="1",
                                        variant="outline",
    ...
    return rx.vstack(
        ...
        rx.hstack(
            rx.vstack(
                ...
                rx.hstack(
                    rx.hstack(
                        rx.icon(tag="calendar", size=11, color=GOLD),
                        rx.text(
                            rx.cond(
                                State.current_event.get("date", "") != "",
                                State.current_event.get("date", ""),
                                "Date TBD",
                            ),
                            color=LIGHT_GRAY,
                    ...
                    rx.hstack(
                        rx.icon(tag="clock", size=11, color=GOLD),
                        rx.text(
                            rx.cond(
                                State.current_event.get("time", "") != "",
                                State.current_event.get("time", ""),
                                "Time TBD",
                            ),
                            color=LIGHT_GRAY,
                    ...
                    rx.hstack(
                        rx.icon(tag="map-pin", size=11, color=GOLD),
                        rx.text(
                            rx.cond(
                                State.current_event.get("venue", "") != "",
                                State.current_event.get("venue", ""),
                                "Venue TBD",
                            ),
                            color=LIGHT_GRAY,
                    ...
                    rx.cond(
                        State.current_event.get("company_name", "") != "",
                        rx.hstack(
                            rx.icon(tag="building-2", size=11, color=GOLD),
                            rx.text(
                                State.current_event.get("company_name", ""),
                                color=LIGHT_GRAY,
                                font_size=["0.55em", "0.65em", "0.75em", "0.85em"],
            ...
            rx.menu.root(
                ...
                rx.menu.content(
                    ...
                    rx.menu.item(
                        ...
                        on_click=EmailState.refresh_email_status(
                            State.current_event_id
                        ),
                    ),
                    rx.menu.separator(),
