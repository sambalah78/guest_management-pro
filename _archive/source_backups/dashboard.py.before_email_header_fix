                        ...
                        lambda guest: rx.table.row(
                            ...
                            rx.table.cell(
                                rx.hstack(
                                    ...
                                    # Keep this as a clearly visible button rather than
                                    # an icon-only action so staff can immediately see
                                    ...
                                    rx.cond(
                                        ...
                                        rx.button(
                                            ...
                                            on_click=lambda: EmailState.open_email_dialog(
                                                guest
                                            ),
                                            size="1",
                                            variant="outline",
                                            ...
                                            is_disabled=EmailState.sending_email_guest_id
                                            == str(
                                                guest.get(
                                                    "ID",
                                                    guest.get(
